# VI. Generative Models for Engineering Data
...
When can a generative model create, reconstruct, enhance, or augment engineering data without corrupting the physical interpretation, uncertainty, or decision process?

## Intended scope

The module will introduce generative adversarial networks (GANs), autoencoders, and diffusion-style concepts through an engineering-data use case such as microscopy, thermal imagery, flow visualization, or sensor signals. It will distinguish synthetic-data generation from measurement, interpolation from extrapolation, and visually plausible output from physically credible output.
...
- a failure audit for artifacts, mode collapse, memorization, distribution shift, or physically implausible samples; and
